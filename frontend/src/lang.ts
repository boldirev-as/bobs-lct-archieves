const lang = {
  ...
  'MediaEditor.Info.Title': 'Название',
  'MediaEditor.Info.TitlePlaceholder': 'Введите название',
  'MediaEditor.Info.Number': 'Номер',
  'MediaEditor.Info.NumberPlaceholder': 'Введите номер',
