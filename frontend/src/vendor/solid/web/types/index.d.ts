...
/**
 * Sets a style property on an element (polyfill for missing function)
 */
export declare function setStyleProperty(element: Element, property: string, value: string | null): void;
