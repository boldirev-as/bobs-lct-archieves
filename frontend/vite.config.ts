...
export default defineConfig({
  ...
  plugins: [
    ...
    // }),
    // Temporarily disabled checker to avoid ESLint stack overflow
    ...
    // }),
    handlebars({
      partialDirectory: resolve(rootDir, 'handlebarsHelpers'),
      context: {
        title: 'Telegram Web',
  ...
  build: {
    ...
    rollupOptions: {
      ...
      external: (id) => {
        // Don't treat any imports as external to avoid resolution errors
        return false;
      }
      // input: {
      //   main: './index.html',
